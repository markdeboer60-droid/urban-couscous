...
import { Plus, Pencil, Trash2, Users, AlertCircle, Search, X, Check, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl p-6 max-w-sm w-full mx-4">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <div className="font-semibold text-gray-900">Klant verwijderen?</div>
                <div className="text-sm text-gray-500 mt-1">De klantgegevens worden definitief verwijderd.</div>
              </div>
            </div>
            <div className="flex gap-3 justify-end">
              <button onClick={() => setVerwijderBevestig(null)} className="px-4 py-2 text-sm text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50">
                Annuleren
              </button>
              <button onClick={() => verwijder(verwijderBevestig)} className="px-4 py-2 text-sm text-white bg-red-600 rounded-lg hover:bg-red-700">
                Verwijderen
              </button>
            </div>
          </div>
